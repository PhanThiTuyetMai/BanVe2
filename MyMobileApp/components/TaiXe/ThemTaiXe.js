...
import { Image, View, StyleSheet, Text, KeyboardAvoidingView , TouchableOpacity, Platform, Alert } from 'react-native';
...
const ThemTX = ({navigation}) => {
    ...
    const addTaiXe = async () => {
        try {
          ...
          Alert.alert('Lưu Ý', 'Đã xảy ra lỗi khi thêm tài xế');
        }
    };
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
            <ScrollView contentContainerStyle={{ alignItems: 'center' }} style={{marginTop: 5}}>
                  ...
                  <View style={{marginBottom: 30}}>
                      ...
                      {avatar && <Image source={{ uri: `file:///data/user/0/host.exp.exponent/cache/ExperienceData/%2540anonymous%252FMyMobileApp-caeae716-14f8-42e8-8345-b048446019bf/ImagePicker/${avatar}`}} style={MyStyles.avatar} />}
                  </View>
