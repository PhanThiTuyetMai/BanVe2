    ...
    const loadNhanVienDetail = async () => {
        try {
            ...
            if (token) {
                ...
                const res = await API.get(`${endpoints['nhanvien']}?ma_nhanvien=${NhanVienID}`, {headers});
                  ...
                  onPress: async () => {
                      try {
                          ...
                          if(token){
                                ...
                                const res = await API.delete(`${endpoints['nhanvien']}${NhanVienID}/Xoa_NV/`, {headers});
                                if (res.status === 204) {
                          ...
                          else { Alert.alert('Lỗi!!', 'Bạn có phải là Quản Lý') }
                          } else {
